		...
		<div class="card card-outline card-dark">
			...
			<div class="card-body">
				<div class="row">
					...
					<?php echo form_open('pembelian/satuan_u/'. $row->id_satuan)?>
						...
						<div class="form-group">
							<div class="float-right">
								<a href="<?php echo site_url('pembelian/view_satuan');?>" class="btn btn-secondary btn-sm" onclick="return confirm('Yakin Cancel ?')">Batal</a>
