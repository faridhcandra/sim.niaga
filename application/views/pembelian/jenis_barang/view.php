				         			...
				         			<tbody>
				         				...
				         				<tr>
				         					...
				         					<td class="project-actions text-center">
												<a href="<?php echo site_url('pembelian/u_jenisbrng/'.$row->id_jnsbrng)?>" data-toggle="tooltip" data-placement="top" title="Ubah" ><i class="fas fa-pencil-alt fa-sm"></i></a>&ensp;
