			...
			<div class="col-md-12">
				<div class="card card-outline card-info">
					<div class="card-header">
						...
						<a href="<?php echo site_url('stok/view_pesbaru');?>" class="btn btn-sm btn-primary float-right">&nbsp;kembali</a>
					</div>
					<div class="row">
						<div class="col-md-12">
										...
										<tbody>
											...
											<tr>
												...
												<td class="project-actions text-center">
													<a  data-toggle="tooltip" data-placement="top" title="Ubah" href="<?php echo site_url('stok/u_pesbaru/'.$row->id_dtl_permintaan)?>"><i class="fas fa-pencil-alt fa-sm"></i></a>&nbsp;
