				         			...
				         			<tbody>
				         				...
				         				<tr>
				         					...
				         					<td class="project-actions text-center">
												<a href="<?php echo site_url('admin/u_kabupaten/'.$row->id_kabupaten)?>" data-toggle="tooltip" data-placement="top" title="Ubah" ><i class="fas fa-pencil-alt fa-sm"></i></a>&ensp;
